...
pub fn run(cli_args: CliArgs) {
    ...
    builder
        ...
        // updater plugin intentionally not registered: MUTTER is a vendored fork and must
        // never check/install upstream Handy releases (see tauri.conf.json bundle config).
